...
void IP_WEBS_SendMem(void *privdata, const void *data, size_t data_len) { (void)privdata; (void)data; (void)data_len; }
int IP_WEBS_METHOD_CopyData(IP_WEBS_CONTEXT *pContext, void *buf, size_t ContentLen) { (void)pContext; (void)buf; (void)ContentLen; return 0; }
